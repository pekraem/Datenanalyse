...
def drawHistosOnCanvas(listOfHistos_,normalize=True,stack=False,logscale=False,options_='histo',ratio=False,ratiomin=0.75,ratiomax=1.25):
    ...
    h=listOfHistos[0]
    if logscale:
        #h.GetYaxis().SetRangeUser(0.0001,h.GetMaximum()*100)
    ...
    if ratio:
        ...
        line.GetYaxis().SetRangeUser(ratiomin,ratiomax)
